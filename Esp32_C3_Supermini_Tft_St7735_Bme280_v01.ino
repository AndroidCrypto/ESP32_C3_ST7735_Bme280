...
/*
Version Management
26.04.2025 V01 Initial programming
*/
...
const char *PROGRAM_VERSION = "ESP32-C3 Supermini ST7735 BME280 V01";
const char *PROGRAM_VERSION_SHORT = "ESP32C3 ST7735 BME280";
const char *DIVIDER = "--------------------";
...
#define BME280_I2C_SDA_PIN 0
#define BME280_I2C_SCL_PIN 1
